...
url = f"https://app.enqurious.com/{project_id}"
...
# Initialize the Selenium WebDriver (change the path to your web driver)
driver = webdriver.Chrome(executable_path="G:/My Drive/research/experiments/amit-work/chromedriver.exe")
